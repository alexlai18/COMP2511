...
import unsw.enrolment.Anonymous;
...
public class EnrolmentTest {
    ...
    public void testComparator() {
        ...
        Anonymous sorter = new Anonymous(students);
        List<Student> sortedStudents = sorter.sort(students);
        assertTrue(sorter.equals(sortedStudents, parseStudentsCSV("/sortedStudents.csv")));
    }
}
